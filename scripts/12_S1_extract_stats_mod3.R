...
projObs <- "+proj=longlat +datum=WGS84 +no_defs "  # Projection of the x and y column of observation file
...
pblapply(pols, function(x){
  ...
  terra::writeRaster(rs_mean, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_mean_from",start,"_to_",end,"2.tif"), overwrite=TRUE)
  terra::writeRaster(rs_max, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_max_from",start,"_to_",end,"2.tif"), overwrite=TRUE)
  terra::writeRaster(rs_min, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_min_from",start,"_to_",end,"2.tif"), overwrite=TRUE)
  terra::writeRaster(rs_sd, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_sd_from",start,"_to_",end,"2.tif"), overwrite=TRUE)
  ...
  pblapply(month, function(y){
    ...
    terra::writeRaster(rsm_mean, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_mean_from ",y,"2.tif"), overwrite=TRUE)
    terra::writeRaster(rsm_max, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_max_from ",y,"2.tif"), overwrite=TRUE)
    terra::writeRaster(rsm_min, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_min_from ",y,"2.tif"), overwrite=TRUE)
    terra::writeRaster(rsm_sd, paste0("E:/Marvin/BB_rf/output/new/Sen_1_2/Ascending/",x,"_sd_from ",y,"2.tif"), overwrite=TRUE)
